...
//                   key={provider.name}
//                   onClick={() => handleProviderSelect(provider)}
//                   className="flex flex-col items-center p-4 bg-white border border-[#D9D9D9] hover:border-blue-500 rounded-lg transition duration-200"
//                 >
//                   <div className="w-16 h-16 relative mb-2">
//                     <Image
//                       src={provider.logo}
...
//               <button
//                 onClick={onClose}
//                 className="px-5 py-2.5 bg-gray-200 text-gray-700 dark:text-neutral-200 rounded-lg hover:bg-gray-300 font-medium transition duration-200"
//               >
//                 Cancel
//               </button>
//             </div>
...
//                       value={formData.smtp_port}
//                       onChange={handleChange}
//                       className="w-full p-3 border border-gray-300 rounded-lg text-gray-900 dark:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200"
//                       required
//                     >
//                       <option value="465">465 (SSL)</option>
//                       <option value="587">587 (TLS/STARTTLS)</option>
...
//                         value={formData.imap_host}
//                         onChange={handleChange}
//                         className="w-full p-3 border border-gray-30 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200"
//                         placeholder="imap.gmail.com"
//                       />
//                     </div>
//                     <div>
