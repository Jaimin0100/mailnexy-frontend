...
const AddSender: React.FC<AddSenderProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900/60 backdrop-blur-sm transition-opacity duration-300">
      <div className="bg-white dark:bg-neutral-800 rounded-2xl p-8 w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl transform transition-all duration-300">
        {step === "select" ? (
          <>
            <h2 className="text-2xl font-bold mb-6 text-gray-800 dark:text-neutral-200 tracking-tight">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
              {emailProviders.map((provider) => (
                <button
                  ...
                  className="flex flex-col items-center p-4 bg-white dark:bg-neutral-700 border border-[#D9D9D9] dark:border-neutral-600 hover:border-blue-500 rounded-lg transition duration-200"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-neutral-200 text-center">
                    {provider.name}
                  </span>
                </button>
              ))}
            ...
            <div className="flex justify-end mt-6">
              <button
                onClick={onClose}
                className="px-5 py-2.5 bg-gray-200 dark:bg-neutral-700 text-gray-700 dark:text-neutral-200 rounded-lg hover:bg-gray-300 dark:hover:bg-neutral-600 font-medium transition duration-200"
              >
                Cancel
              </button>
            </div>
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="border-b border-gray-200 dark:border-neutral-700 pb-6">
                <h3 className="text-lg font-semibold text-gray-700 dark:text-neutral-300 mb-4">General Settings</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-600 dark:text-neutral-400 mb-1.5">
                      Sender Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full p-3 border border-gray-300 dark:border-neutral-600 rounded-lg text-gray-900 dark:text-neutral-200 dark:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-200"
                ...
                <div className="mt-4 flex items-center space-x-4">
                  <label className="flex items-center text-gray-600 dark:text-neutral-400">
                    <input
                      type="checkbox"
                      name="track_opens"
                      checked={formData.track_opens}
                      onChange={handleChange}
                      className="mr-2 h-4 w-4 text-indigo-600 dark:text-indigo-400 focus:ring-indigo-500"
                    />
                    Track Opens
                  </label>
                  <label className="flex items-center text-gray-600 dark:text-neutral-400">
              ...
              {/* SMTP Section */}
              <div className="border-b border-gray-200 dark:border-neutral-700 pb-6">
                <h3 className="text-lg font-semibold text-gray-700 dark:text-neutral-300 mb-4">SMTP (Sending Emails)</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-600 dark:text-neutral-400 mb-1.5">
                      SMTP Host *
                ...
                <div className="mt-4">
                  <button
                    ...
                    className="flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 text-sm font-medium transition duration-200"
                  >
              ...
              {/* IMAP Section */}
              <div className="border-b border-gray-200 dark:border-neutral-700 pb-6">
                <h3 className="text-lg font-semibold text-gray-700 dark:text-neutral-300 mb-4">IMAP (Receiving Emails)</h3>
