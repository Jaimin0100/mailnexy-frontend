      ...
      <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <button 
            ...
            className="text-[#696A71] flex text-[14px] px-4 py-2 border border-gray-300 rounded-xl items-center gap-2 hover:text-[#5570F1] hover:bg-[#5570F1]/10 transition-colors duration-300 shadow-sm"
          >
          ...
          <input
            ...
            className="border border-gray-200 text-gray-600 rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200 transition-all duration-300 shadow-sm min-w-[200px]"
          />
        </div>
      </div>
